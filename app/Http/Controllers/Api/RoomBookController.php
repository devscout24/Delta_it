...
class RoomBookController extends Controller
{
    ...
    public function addAppointment(Request $request)
    {
        ...
        try {
            ...
            //  Create appointment
            $room_appointment = RoomAppointment::create([
            ...
            for ($i = 0; $i < $days; $i++) {
                RoomBookWeelySchedule::create([
                    'appointment_id' => $room_appointment->id,
                    'day'            => $request->day[$i],
            ...
            return $this->success('Meeting Scheduled & Slots Generated Successfully', [
                'appointment' => $room_appointment,
                'slots' => RoomAppointmentSlot::where('appointment_id', $room_appointment->id)->get(),
            ], 200);
        } catch (Exception $e) {
            DB::rollBack();
