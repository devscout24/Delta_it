...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ---------------------------------------------------
        // Create Meeting Booking Template
        // ---------------------------------------------------
        $meetingBooking = MeetingBooking::create([
            'room_id' => 1,
            'company_id' => 1,
            'created_by' => 1,
            'booking_name' => 'General Meeting Booking',
            'booking_date' => now()->toDateString(),
            'booking_color' => '#3498db',
            'online_link' => 'https://zoom.test/link',
            'max_invitees' => 10,
            'description' => 'This is a sample meeting booking configuration.',
            'status' => 'pending',
        ...
        // ---------------------------------------------------
        // Create Schedule (Future 30 Days + Duration)
        // ---------------------------------------------------
        $schedule = MeetingBookingSchedule::create([
            'meeting_booking_id' => $meetingBooking->id,
            'duration' => 60,
            'timezone' => 'UTC',
            'schedule_mode' => 'future_days',
            'future_days' => 30,
            'date_from' => null,
            'date_to' => null,
        ]);
        ...
        // ---------------------------------------------------
        // Create Available Days (Mon to Fri)
        // ---------------------------------------------------
        $days = ['mon', 'tue', 'wed', 'thu', 'fri'];

        foreach ($days as $day) {
            $slot = MeetingBookingAvailabilitySlot::create([
            ...
            // ---------------------------------------------------
            MeetingBookingAvailabilities::create([
        ...
        // ---------------------------------------------------
        // Optional: Weekend Not Available
        // ---------------------------------------------------
